...
pal8 <- viridis::cividis(8) # navy, cadet blue, steel gray, gray, gold-gray, khaki, mustard, yellow
bestdpi <- 600
...
pdf_pod.fm.lung <- ggplot2::ggplot(pod.fm.lung, ggplot2::aes(EC.fm.lung)) + 
    ggplot2::geom_histogram(bins=200, color=pal6[1], fill=pal6[1]
                            , alpha=0.5) +
    ggplot2::theme_bw() +
...
pdf_pod.fm.lung.alt <- ggplot2::ggplot(pod.fm.lung.alt
    ...
    ggplot2::geom_histogram(bins=200, color=pal6[1], fill=pal6[1], alpha=0.5) +
    ggplot2::theme_bw() +
...
cdf <- ggplot2::ggplot(ur.fm.comb, ggplot2::aes(UnitRisk)) +
    ggplot2::stat_ecdf(geom = "point", color=pal6[2], size=1) +
    ggplot2::theme_bw() +
...
ur.fm.all.subtitle <- paste("Unit risk, female mice"
...
cdf2 <- ggplot2::ggplot(df_ur.fm.lung2, ggplot2::aes(FM.Lung)) +
    ggplot2::stat_ecdf(geom = "point", color=pal6[4], size=1) +
    ggplot2::theme_bw() +
    ggplot2::labs(title="Empirical CDF"
                  , x = xlabel_ur
                  , y = "Probability") +
...
# Combine plots into one figure
ur.fm.lung.subtitle <- "Unit risk, female mice, lung tumors"
BMDScaption <- paste(generic.caption,"from BMDS output report", sep = " ")
stg <- grid::textGrob(ur.fm.lung.subtitle, gp=grid::gpar(fontsize=10))
...
pdf_mcomp <- ggplot2::ggplot(ur.fm.comb3
    ...
    ggplot2::scale_color_manual(values=c(pal6[2], pal6[4])) +
    ggplot2::scale_fill_manual(values=c(pal6[2], pal6[4])) +
    ggplot2::theme_bw() +
...
pdf_ur.epi.lymph <- ggplot2::ggplot(ur.epi.lymph.perugm3
    ...
    ggplot2::geom_density(ggplot2::aes(y=ggplot2::after_stat(count/max(count)))
                          , color=pal6[1], size=1) +
    # ggplot2::geom_histogram(bins=200, color=pal8[1], fill=pal8[1], alpha=0.5) +
...
pdf_ur.epi.comb <- ggplot2::ggplot(ur.epi.comb.perugm3
    ...
    ggplot2::xlim(0,0.002) +
    ggplot2::theme_bw() +
    ggplot2::labs(subtitle="All cancers in workers"
                  , x=xlabel_ur
                  , y = "Density") +
    ggplot2::theme(plot.subtitle = ggplot2::element_text(hjust=0.5, size=8)
                   , axis.text = ggplot2::element_text(size=6)
...
p_PDFCDF_ur.epi.comb <- gridExtra::grid.arrange(tg, pdf_ur.epi.lymph, blankPlot
                            , pdf_ur.epi.breast, pdf_ur.epi.comb
                            , cdf_ur.epi.comb, cap1, cap2, ncol=4, nrow=5
                            , layout_matrix = rbind(c(1,1,1,1), c(2,3,4,3)
                                                    , c(5,3,6,3), c(7,7,7,7)
                                                    , c(8,8,8,8))
                            , heights = c(0.3, 3, 3, 0.2, 0.2)
                            , widths = c(3.5,0.1,3.5,0.1))
...
p_PDFCDF_ur.epi.comb3 <- gridExtra::grid.arrange(tg, pdf_epi.lymph.adults
                            , blankPlot
                            , pdf_epi.breast.adults, pdf_epi.comb.adults
                            , cdf_epi.comb.adults, cap1, cap2, ncol=4, nrow=5
                            , layout_matrix = rbind(c(1,1,1,1), c(2,3,4,3)
                                                    , c(5,3,6,3), c(7,7,7,7)
                                                    , c(8,8,8,8))
                            , heights = c(0.3, 3, 3, 0.2, 0.2)
...
pdf_epicomp <- ggplot2::ggplot(ur.epi.comb
                    ...
                    , color=Type, fill=Type)) +
    ggplot2::geom_density(alpha=0.4) + 
    ggplot2::scale_color_manual(values=c(pal6[1], pal6[3])) +
    ggplot2::scale_fill_manual(values=c(pal6[1], pal6[3])) +
    ggplot2::theme_bw() +
    ggplot2::labs(title="Distribution of uncertainty around the mean"
